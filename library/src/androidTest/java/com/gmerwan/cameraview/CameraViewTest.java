...
import com.gmerwan.android.cameraview.test.R;
        ...
        onView(withId(R.id.camera))
                ...
                .check(new ViewAssertion() {
                    ...
                    public void check(View view, NoMatchingViewException noViewFoundException) {
                        ...
                        assertThat(cameraRatio, is(
                                AspectRatioIsCloseTo.closeToOrInverse(viewRatio)));
                    }
                });
    }
        ...
        onView(withId(R.id.camera))
                .check(new ViewAssertion() {
                    ...
                    public void check(View view, NoMatchingViewException noViewFoundException) {
                        ...
                        assertThat(textureRatio, is(
                                AspectRatioIsCloseTo.closeToOrInverse(cameraRatio)));
                    }
                });
    }
